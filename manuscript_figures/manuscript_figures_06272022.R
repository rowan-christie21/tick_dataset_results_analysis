...
# May 12 2020
# Annotating boxplots to indicate significance

# May 16 2020
# Working on adding compact letter display to boxplots
...
#import script from QsRutils packages to add functions for creating letter assignments for groups that are not signifcantly different
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_analysis/proportion_wrong_before_stab_by_metric ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
proportion_wrong_before_stab_by_metric
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_analysis/stability_time_by_metric ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
stability_time_by_metric
dev.off()
