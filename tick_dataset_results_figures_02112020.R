...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/years_to_reach_stability ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
years_to_reach_stability
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/years_to_reach_stability_line_chart ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
years_to_reach_stability
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/yrs_stab_by_samp_tech ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
yrs_stab_by_samp_tech
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/ave_num_phases_by_start_year ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
ave_num_phases_by_start_year
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/years_to_reach_stability_for_each_ls ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
years_to_reach_stability_ls
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/years_to_reach_stability_for_each_gs ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
years_to_reach_stability_gs
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/proportion_sig_w_by_state ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
proportion_sig_w_by_state
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/num_phases_by_start_year ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
num_phases_by_start_year
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/num_phases_by_data_range ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
num_phases_by_data_range
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/por_wrong_by_stab_time ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
por_wrong_by_stab_time
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/por_wrong_by_data_range ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
por_wrong_by_data_range
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/proportion_sig_by_ticks_infected ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
proportion_sig_by_ticks_infected
dev.off()
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/stability_time_by_ticks_infected ",Sys.Date(),".png", sep = ''), width = 600, height = 454)
stability_time_by_ticks_infected
dev.off()
...
tick_dataset_results <- readxl::read_xlsx("D:/Ixodes_scapularis_research_2019/tick_dataset_results_algorithms/tick_dataset_results_2_11_2020.xlsx", sheet = 1)
...
#subset of data of ticks reported to be infected
tick_dataset_results_sub_ti <- tick_dataset_results[tick_dataset_results$tested_for_b_burgdoferi == "Y",] #subset(tick_dataset_results, life_stage == "fraction of adult ticks infected with B. burgdorferi" | life_stage == "fraction of nymphal ticks infected with B. burgdorferi")

ggplot(tick_dataset_results, aes(x = tick_dataset_results$tested_for_b_burgdoferi, y = tick_dataset_results$proportion_right)) + geom_point()

t.test(tick_dataset_results$proportion_right, tick_dataset_results_sub_ti$proportion_right)
# t = 1.5863, df = 43.475, p-value = 0.1199
# t-value indicates probability between 0.80 and 0.90
# high probability of difference between datasets
#
# p-value higher than 0.05, accept null hypothesis
# therefore alternative hypothesis: true difference in means is not equal to 0 is not supported
...
tick_dataset_results$total_ticks_vs_infected_ticks <- "Total ticks"

#proportion significant by ticks infected and total ticks
proportion_sig_by_ticks_infected <- ggplot(tick_dataset_results, aes(x = tick_dataset_results$tested_for_b_burgdoferi, y = tick_dataset_results$proportion_right)) +
  geom_boxplot() + 
  scale_x_discrete(name = "Ticks") +
  scale_y_continuous(name = "Proportion significantly right") +
  ggtitle("Proportion significantly right by ticks \ninfected") + 
